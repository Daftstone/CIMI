...
for cur_batch, (batch_x, batch_y) in enumerate(pbar):
...
avg_lens = {"clickbait": 15.5967, "hate": 23.773, "yelp": 136.3227, "imdb": 245.66}
print("sensitivity:", (10 - np.mean(sen_list)) / 10.)
print("dffot:", np.mean(dffot_list) / avg_lens[args.dataset])
